...
export const PlanMonthly = () => {
  ...
  return (
    <div>
      <h1>Monthly Plan</h1>
      <h2>Let's create a monthly plan</h2>
      <p>Use the slider below to choose how many <strong>hours</strong> per month you would like to contribute towards your website?</p>
